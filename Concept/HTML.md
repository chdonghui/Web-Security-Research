...
# Reference
- mdn.2026.03.19 Accessed."HTML 시작하기".mozilla.[https://developer.mozilla.org/ko/docs/Learn_web_development/Core/Structuring_content/Basic_HTML_syntax](https://developer.mozilla.org/ko/docs/Learn_web_development/Core/Structuring_content/Basic_HTML_syntax)
- mdn.2026.03.19 Accessed."Hypertext (하이퍼텍스트)".mozilla.[https://developer.mozilla.org/ko/docs/Glossary/Hypertext](https://developer.mozilla.org/ko/docs/Glossary/Hypertext)
- 전학성.2025.10.07 Updated."마크업(Markup)이란 무엇인가?".Wikidocs "AI로 경영하라".[https://wikidocs.net/301895](https://wikidocs.net/301895)
- mdn.2026.03.19 Accessed."\<a\>".mozilla.[https://developer.mozilla.org/ko/docs/Web/HTML/Reference/Elements/a](https://developer.mozilla.org/ko/docs/Web/HTML/Reference/Elements/a)
