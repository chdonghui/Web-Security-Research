# What is Network?
Network는 Net와 Work의 합성어입니다.

- Net: 그물(망)
- Work: 일, 업무

그물로 된 망 형태가  기반이 되어 다양한 장치 간의 정보 교환 등의 업무를 수행합니다. 네트워크 규모에 따라 아래와 같이 나눌 수 있습니다.
...
- 한국정보통신기술협회.2026.03.19 Accessed."네트워크, network".TTA.[URL](http://word.tta.or.kr/dictionary/dictionaryView.do?subject=network)
